...
<div className="overflow-hidden container md:flex-row  gap-x-4 flex-col px-4 xl:px-[120px] mx-auto w-full flex md:pt-[140px] pt-[120px] md:h-[500px] lg:h-[700px]">
 ...
 <div className="flex flex-wrap gap-4 items-center">
    <button
  className="text-black hover:text-black bg-transparent hover:bg-tron-blue transition-all px-6 border-2 border-tron-blue hover:border-black mt-5 md:mt-0 lg:mt-5 inter text-base sm:text-lg py-2.5 rounded-full font-medium tracking-wide"
>
  Try VMX Models
</button>
