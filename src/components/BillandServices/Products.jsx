            ...
            <div className="w-full py-20 ">
                <div className="container  mx-auto">
                    <div className="w-full flex px-4 flex-col items-center">
                        ...
                        Discover our cloud-first <br className="sm:block hidden" /> portfolio.
                        </h1>
                        <p className="text-center text-gray-700 mt-3 inter font-light">
                        Deliver exceptional customer and employee experiences for your financial institution with  <br className="sm:block hidden" /> best-in-class Meraki technologies.
                        </p>
                    </div>
                    ...
                    {cards.map((card, index) => (
                        <div key={index} className=" flex flex-col items-center">
                            ...
                            <div className="relative rounded-3xl overflow-hidden w-full h-full">            <img className="w-full object-cover" src={card.imgbg} alt="" />
                                ...
                                /></div>
                                <div>
                                <button className="text-black border-2 border-tron-blue  hover:border-black hover:bg-transparent transition-all bg-tron-blue px-6  mt-5 inter lg:text-lg sm:text-sm py-3 rounded-full font-medium tracking-wide">
       {card.button}
    </button>
                                </div>
